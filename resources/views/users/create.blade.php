...
<body>
    ...
    <div>
        <h3 id="head">افزودن کاربر جدید</h3>
    </div>
    ...
    {!! Form::open(['method' => 'POST', 'action' => 'UsersController@store', 'class' => 'formstyle', 'files'=>true]) !!}
        <div class="elements">
        ...
        <div class="elements">
            ...
            {!! Form::select('role_id', ['' => 'انتخاب گزینه'] + $roles, null, ['class' => 'instyle']) !!}
        </div>  
